...
<footer style="text-align: center;">
    <c:if test = "${!isAuthenticated}">
        ...
        &nbsp; Aplicación Java registrada en <a target="_blank" href=https://portal.azure.com>Azure Portal</a> con <em>redireccionamiento URI</em> configurado.
    </c:if>
    <c:if test = "${isAuthenticated}">
        <div style="text-align:center; justify-content:center;">
        <strong> ¡Felicitaciones, ingresaste a tu cuenta ✨! </strong>
        </div>
    </c:if>

    <br><br>
    <p>&copy; 2023 - Manríquez Fernando<p>
</footer>
